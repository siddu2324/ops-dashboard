...
// Mock data
const applications = [
  { name: "Microsoft IIS on AZSHPCACHE01v", status: "Up" },
  { name: "Microsoft IIS on AZSHPWEB01v", status: "Down" },
  { name: "Microsoft IIS on AZSHPWEB02v", status: "Critical" },
  { name: "Microsoft IIS on EASTARM01v", status: "Up" },
  { name: "Microsoft IIS on EASTFILE01v", status: "Warning" },
  { name: "Microsoft IIS on EASTROOTCA", status: "Critical" },
  { name: "Microsoft IIS on EASTWSUS01v", status: "Up" },
  { name: "Microsoft IIS on LAB-NOCEYAFV01", status: "Up" },
  { name: "Microsoft IIS on NOCFILE01v", status: "Down" },
  { name: "Microsoft IIS on NOCFTP01v", status: "Warning" },
  { name: "Microsoft IIS on NOCMIRROR01v", status: "Up" },
  { name: "Microsoft IIS on NOCSHPAPP01v", status: "Up" },
  { name: "Microsoft IIS on ODv2026-2-HCO", status: "Critical" },
  { name: "Microsoft IIS on WESTARR01v", status: "Down" },
  { name: "Microsoft IIS on WESTFILE01v", status: "Up" },
  { name: "Microsoft IIS on WESTSTIGIIIS85v", status: "Warning" },
  { name: "Microsoft IIS on WESTWSUS01v", status: "Up" },
];
      ...
      <div className="bg-[var(--color-panel)] border border-[var(--color-border)] rounded-2xl max-w-3xl w-full max-h-[90vh] flex flex-col shadow-2xl">
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-5">
          <div className="text-base text-[var(--color-text)]">
            ...
            {isAlert ? data.status?.toLowerCase() : "up"} – Microsoft IIS
          </div>
...
// ---- Main Component ----
export default function IISPage({ go }) {
  const [modalOpen, setModalOpen] = useState(false);
  const [modalData, setModalData] = useState(null);
  const [acknowledgedApps, setAcknowledgedApps] = useState(new Set());

  const handleHelp = () => {
    toast.info("Help: Contact administrator for IIS support.");
  };
  ...
  return (
    <div className="space-y-4 max-w-7xl mx-auto">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[var(--color-text)]">IIS Application Summary</h1>
