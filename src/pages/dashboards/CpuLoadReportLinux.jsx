...
// ----- Filter Linux servers and generate CPU data -----
...
const generateProblemsForHost = (hostname) => {
  const problemTemplates = [
    ...
    { 
      status: "PROBLEM", 
      severity: "High", 
      info: "High CPU usage (>90%)", 
      duration: "5h 12m",
      detail: {
        title: `${hostname} · high CPU`,
        source: "Infrastructure",
        host: hostname,
        service: "Ubuntu 22.04",
        ...
        ip: "10.2.1.12",
        confidence: "88%",
        rootCause: `${hostname} is experiencing high CPU utilization (92%). This has crossed the critical threshold (85%) and is likely impacting application performance.`,
        metrics: [
          "CPU utilization 92%",
          "System load 4.5",
          "Context switches 12k/s"
        ],
        recommendation: "Investigate processes consuming CPU on ${hostname}. Consider scaling resources or optimizing application code."
      }
    },
    { 
      status: "PROBLEM", 
